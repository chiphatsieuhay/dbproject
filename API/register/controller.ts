...
//console.log(`this is id`)
    let query =`insert into users (id, first_name, last_name, password, dob, id_branch, grade, SEOXU, id_type_member, user_img_profile) values ("${id}", "${first_name}", "Le", "1234567", "2000-10-16", 1, 0, 0, 1, "Not found"); `;
